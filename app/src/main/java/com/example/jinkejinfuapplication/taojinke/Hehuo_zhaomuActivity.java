...
public class Hehuo_zhaomuActivity extends BaseActivity {
    private ImageView erweima;
    private Button fenxiang_hehuo;
    private String proxy_URL;
    @Override
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_hehuo_zhaomu);
        setTitle("招募合伙人");
        erweima=findView(R.id.erweima);
        fenxiang_hehuo=findView(R.id.fenxiang_hehuo);
        fenxiang_hehuo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MyzhanghuActivity.share_tuiguan(Hehuo_zhaomuActivity.this, proxy_URL,"招募合伙人", "邀请您加入淘金客招募合伙人，轻松赚收益！");
            }
        });
    }
    ...
    protected void initData() {
        String url1= AppBaseUrl.ZHAOMU_HEHUO;
        ...
        x.http().post(params1, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    jObj=jObj.getJSONObject("proxy_code");
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                ToastUtil.show(Hehuo_zhaomuActivity.this,"网络发生错误!");
            }
            @Override
