...
public class SpinnerAdapater extends BaseAdapter{
    private String[] mList;
    private Context mContext;

    public SpinnerAdapater(Context mContext, String[] mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView=_LayoutInflater.inflate(R.layout.simple_spinner_dropdown_myitem,null);
        if(convertView!=null) {
