...
import com.example.jinkejinfuapplication.taojinke.huiyuan.Huiyuan_mingxiAdapter;
...
public class Mingxi_hehuorenActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_mingxi_hehuo);
        setTitle("收入明细");
    ...
    protected void initData() {
        String url= AppBaseUrl.MINGXI_HEHUOREN;
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                ToastUtil.show(Mingxi_hehuorenActivity.this,"网络发生错误!");
            }
            @Override
