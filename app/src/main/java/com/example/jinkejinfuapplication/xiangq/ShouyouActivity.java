...
public class ShouyouActivity extends BaseActivity implements View.OnClickListener {
    private String mId;
    ...
    private Button xiazai_an,xiazai_ios;
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        this.mContext = this;
        rootView = getLayoutInflater().from(this).inflate(R.layout.activity_shouyou, null);
        ...
        xiazai_an=findView(R.id.xiazai_android);
        xiazai_an.setOnClickListener(this);
        xiazai_ios=findView(R.id.xiazai_ios);
        xiazai_ios.setOnClickListener(this);
        ...
        shipingAdapter=new Shiping_youxiAdapter(this,shipingList);
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    imgAdapter = new ImgAdapter(ShouyouActivity.this,imglist);
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                ToastUtil.show(ShouyouActivity.this,"网络发生错误!");
            }
            @Override
        ...
        x.http().post(params1, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    gameAdapter=new Shouye_gameAdapter(ShouyouActivity.this,mXiangsilist);
    ...
    private void initshiping() {
        shipingList.clear();
        String url1= AppBaseUrl.SHIPING_MORE;
        RequestParams params1 = new RequestParams(url1);
        params1.addBodyParameter("id",mId);
        x.http().post(params1, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                LalaLog.i("相关视频",result);
                try {
                    JSONObject jObj = new JSONObject(result);
                    ...
                    for (int i=0;i<jrry.length();i++) {
                        ...
                        map.put("title",temp.getString("title"));
                        map.put("background",AppBaseUrl.BASEURL+temp.getString("background"));
                        map.put("video",AppBaseUrl.BASEURL+temp.getString("video"));
                        map.put("id",temp.getString("id"));
                        map.put("gameId",temp.getString("gameId"));
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    {
                        ptrFrameLayout.refreshComplete();
                        ToastUtil.show(ShouyouActivity.this,"没有更多数据了");
                    }else
                    {
    ...
    private void init() {
        ...
        if ( map_xiangq.get("android").isEmpty()){
            xiazai_an.setBackgroundResource(R.drawable.huise_bk);
            xiazai_an.setClickable(false);
        }
        if ( map_xiangq.get("ios").isEmpty()){
            xiazai_ios.setBackgroundResource(R.drawable.huise_bk);
            xiazai_ios.setClickable(false);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.back:
                ...
                break;
            case R.id.more:
                shareGameWindow(this,more,map_xiangq);
                break;
            case R.id.zhankai:
                if(flag){
                    flag = false;
            ...
            case R.id.xiazai_android:
                ...
                break;
            case R.id.xiazai_ios:
                String url1 = map_xiangq.get("ios");
                if (url1.isEmpty()){
                    showToastMsg("暂时不提供下载！");
                }else {
                    String url4= AppBaseUrl.XIAZAI_TONGJI;
    ...
    public static void shareGameWindow(final Activity mContext, ImageView imageView, final Map<String, String> map)
    {
        ...
        web = new UMWeb(AppBaseUrl.SHARE_GAME+ map.get("id")+"-"+MyApplication.getInstance().getYonghuBean().getUdcode());
        web.setTitle(map.get("game_name"));
        web.setDescription(map.get("introduce_text"));

        UMImage thumb =  new UMImage(mContext, map.get("game_pic"));
