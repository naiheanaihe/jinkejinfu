...
public class Shiping_youxiAdapter extends BaseRecycleAdapter {
    private Context context;
    private List<Map<String,String>> mList;

    public Shiping_youxiAdapter(Context context, List<Map<String,String>> mList) {
        this.context = context;
        this.mList = mList;
    }
    public Shiping_youxiAdapter(Context context) {
        this.context = context;
    }
    ...
    protected BaseRecycleViewHolder onCreateNormalViewHolder(ViewGroup parent, int viewType) {
        ...
        final TextView name;
        View view= LayoutInflater.from(context).inflate(R.layout.item_shiping,parent,false);
        ...
        final BaseRecycleViewHolder holder=new BaseRecycleViewHolder(view) {
            ...
            public void onBindViewHolder(int position) {
                ...
                name.setText(mList.get(position).get("title"));
            }
