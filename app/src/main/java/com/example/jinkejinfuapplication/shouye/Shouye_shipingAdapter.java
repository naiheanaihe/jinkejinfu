...
public class Shouye_shipingAdapter extends BaseRecycleAdapter {
    private Context context;
    private List<Map<String,String>> mList;

    public Shouye_shipingAdapter(Context context, List<Map<String,String>> mList) {
        this.context = context;
        this.mList = mList;
    }
    public Shouye_shipingAdapter(Context context) {
        this.context = context;
    }
    ...
    protected BaseRecycleViewHolder onCreateNormalViewHolder(ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.item_shiping_shouye,parent,false);
