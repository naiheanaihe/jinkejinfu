...
import com.example.jinkejinfuapplication.shouye.ShouyeAdapter;
import com.example.jinkejinfuapplication.taojinke.SpinnerAdapater;
...
public class HuatiFragment extends BaseFragment implements View.OnClickListener {
    ...
    private Hudong_huatiAdapter hudong_huatiAdapter;
    ...
    private TextView num_huati,num_jinri,reliao,myfenxiang,myhuati;
    @Override
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    reliao.setText(jObj.getString("topic_hot"));
                    ...
                    for (int i=0;i<jrry.length();i++) {
                        ...
                        map.put("img1",AppBaseUrl.isHttp(ob.getString("img1")));
                        map.put("img2",AppBaseUrl.isHttp(ob.getString("img2")));
                        map.put("state",ob.getString("state"));
                        map.put("commentnum",ob.getString("commentnum"));
                        mHuatiList.add(map);
                    }
                    hudong_huatiAdapter.setmList(mHuatiList);
                    hudong_huatiAdapter.notifyDataSetChanged();
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    }else
                    {
                        ...
                        ptrFrameLayout.refreshComplete();
                        hudong_huatiAdapter.notifyItemRangeInserted(page*10,mNewslist.size());
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void initView(View view) {
        ...
        hudong_huatiAdapter=new Hudong_huatiAdapter(getContext());
        rec_huati.setAdapter(hudong_huatiAdapter);

        num_huati= (TextView) view.findViewById(R.id.num_huati);
        num_jinri= (TextView) view.findViewById(R.id.num_jinri);
        reliao= (TextView) view.findViewById(R.id.reliao);
        myfenxiang= (TextView) view.findViewById(R.id.btn_huati_fenxiang);
        myhuati= (TextView) view.findViewById(R.id.btn_huati_myhuati);
        myfenxiang.setOnClickListener(this);
        myhuati.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.add:
                intent=new Intent(getContext(),AddHuatiActivity.class);
                getContext().startActivity(intent);
                break;
            case R.id.btn_huati_fenxiang:
                intent=new Intent(getContext(),MyFenxiangAndHuatiActivity.class);
                getContext().startActivity(intent);
                break;
