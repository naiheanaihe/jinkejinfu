...
public class WendaActivity extends BaseActivity implements View.OnClickListener {
    private TextView mytitle,neirong,zuozhe,chakan_number,pinglun_number,num_liuyin;
    ...
    protected void initData() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                ToastUtil.show(WendaActivity.this,"网络发生错误!");
            }
            @Override
    ...
    private void redate(){
        ...
        params2.addBodyParameter("sort","topic1");
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    {
                        ptrFrameLayout.refreshComplete();
                        ToastUtil.show(WendaActivity.this,"没有更多数据了");
                    }else
                    {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.pinglun:
                ...
                params1.addBodyParameter("sort","topic1");
