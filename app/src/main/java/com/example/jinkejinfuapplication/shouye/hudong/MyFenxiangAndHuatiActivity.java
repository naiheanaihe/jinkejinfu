...
public class MyFenxiangAndHuatiActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private Hudong_myhuatiAdapter myhuatiAdapter;
    private int page=0;
    private String paixu="1";
    private String type="1";
    @Override
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_my_fenxiang_and_huati);
        setTitle("我的动态");
        ...
        findViewById(R.id.add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MyFenxiangAndHuatiActivity.this,AddHuatiActivity.class);
        ...
        myhuatiAdapter=new Hudong_myhuatiAdapter(this,mhuatiList);
        ...
        if (type.equals("1")){
            ...
            x.http().post(params, new Callback.CommonCallback<String>() {
                ...
                public void onError(Throwable ex, boolean isOnCallback) {
                    ...
                    ToastUtil.show(MyFenxiangAndHuatiActivity.this,"网络发生错误!");
                }
                @Override
                ...
                public void onSuccess(String result) {
                    ...
                    try {
                        ...
                        for (int i=0;i<jrry.length();i++) {
                            ...
                            bean.setReti(temp.getString("hot"));
                        ...
                        myhuatiAdapter.setmList(mhuatiList);
                        myhuatiAdapter.notifyDataSetChanged();
                        rec.setAdapter(myhuatiAdapter);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            ...
            x.http().post(params, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    try {
                        ...
                        {
                            ptrFrameLayout.refreshComplete();
                            ToastUtil.show(MyFenxiangAndHuatiActivity.this,"没有更多数据了");
                        }else
                        {
